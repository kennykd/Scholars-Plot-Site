...
// const suggestions = [
//   "Plan my tasks for the day",
//   "Create study sessions for my upcoming exams",
...
const initialMessages: MessageType[] = [
  {
    ...
    from: "assistant",
    content:
      "Hi! I'm Ploty, your little assistant! I can help you figure out what to focus on, build a study schedule for the week, check if you're overloaded, or add a new task. What do you want to look into?",
  },
];
...
const suggestions = [
  ...
  "Add a task: finish lab report, due Friday",
  "How are my current priorities looking?",
];
